...
//------------------------------------------------------------------------------------------
bool CreateAxis( ID3D11Device* pDevice, f32 length, ID3D11Buffer** ppVB )
{
    Vertex vertices[ 6 ];

    // X軸.
    {
        vertices[ 0 ].position = asdx::Vector3( 0.0f, 0.0f, 0.0f );
        vertices[ 0 ].color    = asdx::Vector4( 1.0f, 0.0f, 0.0f, 1.0f );

        vertices[ 1 ].position = asdx::Vector3( length, 0.0f, 0.0f );
        vertices[ 1 ].color    = asdx::Vector4( 1.0f, 0.0f, 0.0f, 1.0f );
    }

    // Y軸.
    {
        vertices[ 2 ].position = asdx::Vector3( 0.0f, 0.0f, 0.0f );
        vertices[ 2 ].color    = asdx::Vector4( 0.0f, 1.0f, 0.0f, 1.0f );

        vertices[ 3 ].position = asdx::Vector3( 0.0f, length, 0.0f );
        vertices[ 3 ].color    = asdx::Vector4( 0.0f, 1.0f, 0.0f, 1.0f );
    }

    // Z軸.
    {
        vertices[ 4 ].position = asdx::Vector3( 0.0f, 0.0f, 0.0f );
        vertices[ 4 ].color    = asdx::Vector4( 0.0f, 0.0f, 1.0f, 1.0f );

        vertices[ 5 ].position = asdx::Vector3( 0.0f, 0.0f, length );
        vertices[ 5 ].color    = asdx::Vector4( 0.0f, 0.0f, 1.0f, 1.0f );
    }
