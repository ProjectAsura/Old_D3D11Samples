...
ASDX_INLINE
Matrix Matrix::CreateLookTo( const Vector3& cameraPosition, const Vector3& cameraDirection, const Vector3& cameraUpVector )
{
    Matrix result;
    Vector3 zaxis = -cameraDirection;
    zaxis.Normalize();
...
ASDX_INLINE
void Matrix::CreateLookTo( const Vector3 &cameraPosition, const Vector3 &cameraDirection, const Vector3 &cameraUpVector, Matrix &result )
{
    Vector3 zaxis = -cameraDirection;
    zaxis.Normalize();
